...
-- INSERT INTO customers (customer_name, customer_email, customer_city, signup_date) VALUES
...
-- INSERT INTO products (product_name, product_category, product_price, stock) VALUES
...
-- query for getting total_revenue
-- SELECT SUM(amount) AS total_revenue FROM payments;


-- query for getting revenue by product
-- SELECT 
-- 	p.product_name,
-- 	ROUND(SUM(oi.quantity * p.product_price))
--     AS revenue
-- FROM order_items oi
-- JOIN products p
...
-- query for getting top customer by spending 
-- SELECT 
-- 	c.customer_name,	
--     ROUND(SUM(py.amount)) 
-- 	AS total_spend
...
-- query for getting cancelled orders
-- SELECT 
-- 	COUNT(*) 
-- FROM orders 
